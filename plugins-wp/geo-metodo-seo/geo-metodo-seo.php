...
// Bridge: integração com Content Audit & Cleanup (CAC)
// Carregado após ContentUpdater e LogService (dependências do bridge).
if ( file_exists( GEO_METODO_SEO_PATH . 'includes/Bridge/CACIntegration.php' ) ) {
    require_once GEO_METODO_SEO_PATH . 'includes/Bridge/CACIntegration.php';
}
if ( class_exists( 'GeoMetodoSEO\\Bridge\\CACIntegration' ) ) {
    \GeoMetodoSEO\Bridge\CACIntegration::register_hooks();
}
